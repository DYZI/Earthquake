...
To install the `earthquakr` package, the user must install the `devtools` package.  Then, to download and install the `earthquake` package, use the following commands:
