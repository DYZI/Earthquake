...
# Links:
* [Package earthquake GitHub](https://github.com/DYZI/Earthquake)
* [Package fars Travis CI](https://travis-ci.org/DYZI/Earthquake)
* [Package Appveyor](https://ci.appveyor.com/project/DYZI/Earthquake)
